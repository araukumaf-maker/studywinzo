...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    $err = 'Invalid credentials. Check ADMIN_USER and ADMIN_PASS in Wasmer environment variables.';
}
?>
...
<input type="password" name="pass" placeholder="Admin password" class="w-full bg-[#0a0f1a] border border-slate-700 text-white rounded-lg px-3 py-2.5 text-sm" required/>
...
<p class="text-center text-slate-500 text-[11px] mt-4">Credentials are configured in Wasmer environment variables.</p>
</div></body></html>
